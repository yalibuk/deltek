---
baslik: "Steering Head"
adres: "hdd-steering-head"
seoBaslik: "HDD Steering Head: Drill Bit and Sonde Housing"
ozet: "The HDD steering head: duckbill head, sonde housing, steering with an angled bit, carbide and cone bits, and fluid-driven rock drilling with a mud motor."
anahtarKelimeler: "steering head, duckbill, HDD drill bit, sonde housing, mud motor, rock drilling HDD, tricone bit, directional drilling head"
bannerAlt: "HDD steering head — duckbill directional drilling bit illustration"
duzen: urun
...
bloklar:
  - metin: |-
    ...
    gorsel: "/images/icerik/ordek-agizli-duckbill-yonlendirme-basligi.webp"
    alt: "Duckbill steering head and the sonde housing inside it"
  - metin: |-
    ...
    gorsel: "/images/icerik/baslik-eksenine-acili-yerlestirilen-delici-uc.webp"
    alt: "Drill bit mounted at an angle to the head axis — the physics of steering in HDD"
  - metin: |-
    ...
    gorsel: "/images/icerik/kaya-zemin-icin-sivi-tahrikli-delgi.webp"
    alt: "Fluid-driven drilling for rock: mud motor and tricone bit"
  - baslik: "Choosing the steering head for the ground"
    metin: |-
