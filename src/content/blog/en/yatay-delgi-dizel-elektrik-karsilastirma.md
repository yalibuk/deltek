...
1. They allow very long-distance operations; in the countryside it is still easier to carry diesel than electricity.
2. They make it easier to work on sites without grid power — and 90% of large rigs work in the countryside.
3. It is easier to build the HDD rigs used in very heavy rock-drilling operations (400–800 tonne range).
